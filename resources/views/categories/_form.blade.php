<div class="space-y-6">
    <section class="card">
        ...
        <div class="card-body grid grid-cols-1 gap-4">
            <div>
                <label for="name" class="label">Nama Kategori <span class="text-danger">*</span></label>
            ...
            <div>
                ...
                <textarea id="description" name="description" rows="4" maxlength="5000"
                          class="input @error('description') border-danger @enderror">{{ old('description', $category?->description) }}</textarea>
